...
public class BuildUIManager : MonoBehaviour
{
    ...
    [SerializeField] public CheckInventoryEvent checkInventory;
    ...
    //<-------------------< Button Functions for BuildManager >------------------>//
    //These functions will be attatched to the button in BuildUIManager.cs
