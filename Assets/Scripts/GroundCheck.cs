...
public class GroundCheck : MonoBehaviour
{
    ...
    //         playerMovement.isGrounded = true;  // If raycast hits the ground, set isGrounded to true.
    //     }
    //     else
    //     {
    //         playerMovement.isGrounded = false;  // If raycast doesn't hit the ground, set isGrounded to false.
    //     }
    // }
